...
void themeWin() {
	...
	addTextCentered(themeWin, 0, 200, -1, 250, "Choose a Theme", 0x000000, DFONT("20"));
...
#include "icon.xpm"
	...
	addTextCentered(win, 0, 200, -1, 250, "Hey!", 0x000000, DFONT("20"));
	addTextBlock(win, 10, 250, -1, 750, "Welcome to your new phone, the phone you recieved is in a beta state so don't expect everything to be perfect. There will be crashes, errors, problems, the whole nine yards. If you have any issues, use the feedback app in your application drawer and I'll get on it as fast as I can. You could also just scream at me on Snapchat but I prefer the feedback app. Sorry that the font looks like garbage right now, this is just an inherint issue with the rendering system of this phone. It'll be fixed soon, and it shouldn't affect Android apps, Just a few things to setup before the phone is yours.", 0x000000, ' ', DFONT("18"));
